...
export async function initPharmaSchema() {
  ...
  await pool.query(`
    ...
    SELECT
      ...
      b.market_shortage,
      b.photosensitive,
      b.storage_note       AS photo_storage,
      b.reconstitution     AS photo_reconstitution,
      b.dilution           AS photo_dilution,
      b.administration     AS photo_administration,
      b.additional_comments AS photo_comments,
      b.volume,
      b.volume_unit,
      b.mu_qty,
      b.d_rx_unit,
